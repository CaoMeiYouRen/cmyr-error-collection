...
// Node 端
// cjs 版本
const { ErrorCollection } = require('error-collection') // index.js
// esm 版本
import { ErrorCollection } from 'error-collection' // index.esm.js

//浏览器端
// 非 esm 版本 index.umd.js 
// <script src="./index.umd.js">
const ErrorCollection = window.ErrorCollection.ErrorCollection
